...
각자 _구간_ 이 다르되, _바통_ 을 잘 넘겨야 1등.

- **기획자 A** — PRD 쓰고 Jira 티켓 (1구간)
- **코더 B** — API 계약 따라 구현 (2구간)
- **테스터 C** — E2E 시나리오 검증 (3구간)
- **리뷰어 D** — AI Actions 코드 리뷰 (4구간)
- **운영자 (전원)** — 모니터링·알림 (운영 구간)

> 본인 구간 잘하고 _바통_ 잘 넘기는 게 핵심.
...
> 다음 주: **Week 10 — 면접 생존 챌린지** + 8/8 피날레.
