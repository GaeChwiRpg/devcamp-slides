...
> W8 종료 시 _팀 프로젝트 진입 게이트_ — 6 공통 + 라이프사이클 2+ 흔적.
...
> 5축 평균 = `overall_score`. 매주 평균 ≥ 3.0 이면 진급 게이트 통과.
...
> _라이브로 시연_ — 실제 sample repo PR 1건.
